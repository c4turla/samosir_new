...
class IceCruiserServiceController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('IceCruiserServices/Index', [
            'services' => $services,
    ...
    public function create()
    {
        ...
        return Inertia::render('IceCruiserServices/Create', [
            'vessels' => $vessels,
        ]);
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            // Fallback for single item if items array is missing
        ...
        return redirect()->route('ice-cruiser-services.index')->with('success', 'Jasa Ice Cruiser berhasil disimpan.');
    }

    public function show($id)
    {
        $service = EquipmentService::with(['vessel', 'items'])->findOrFail($id);
        return Inertia::render('IceCruiserServices/Show', [
            'service' => $service,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('ice-cruiser-services.index')->with('success', 'Jasa Ice Cruiser berhasil diperbarui.');
    }
    ...
    public function calculate(Request $request, $id)
    {
        ...
        return redirect()->route('ice-cruiser-services.index')->with('success', 'Perhitungan biaya berhasil disimpan.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('ice-cruiser-services.index')->with('success', 'Jasa Ice Cruiser berhasil dihapus.');
    }
