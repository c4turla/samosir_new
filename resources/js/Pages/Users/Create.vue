...
<template>
  <AppLayout>
    ...
    <div class="mb-6">
      ...
      <h1 class="text-2xl font-bold text-gray-900 dark:text-white mt-2">Tambah User Baru</h1>
      <p class="text-gray-600 dark:text-gray-400">Tambahkan user baru ke dalam sistem</p>
    </div>
    ...
    <form @submit.prevent="storeUser">
      <div class="space-y-12 bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 dark:ring-gray-700 sm:rounded-xl">
        <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 px-4 py-6 sm:p-8">
          ...
          <div class="sm:col-span-3">
            <label for="password_confirmation" class="block text-sm/6 font-medium text-gray-900 dark:text-white">Konfirmasi Password</label>
            <div class="mt-2">
              <input
