...
const submit = () => {
    ...
    form.post(`/ice-cruiser-services/${props.service.id}/calculate`)
}
</script>

<template>
    <AppLayout>
        <Head title="Proses Perhitungan Ice Cruiser - SAMOSIR" />

        <div class="max-w-5xl mx-auto py-6 px-4">
            <div class="mb-6 flex justify-between items-center">
                <div>
                    <h1 class="text-xl font-bold text-gray-900 dark:text-white">Proses Perhitungan Ice Cruiser</h1>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                        Selesaikan perhitungan biaya pemakaian Ice Cruiser
                    </p>
                </div>
                <Link
