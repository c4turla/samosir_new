    ...
    <AppLayout>
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Edit Kapal</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
                    Perbarui informasi kapal di bawah
                </p>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div v-if="form.errors.approval_status" class="mt-2 text-sm text-red-600 dark:text-red-400">
                            {{ form.errors.approval_status }}
                        </div>
                    </div>
                    ...
                    <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                        <p class="text-sm text-blue-800 dark:text-blue-200">
                            <strong>Info:</strong> Data SIPI akan ditampilkan di tabel daftar kapal dengan status berdasarkan tanggal berakhirnya (Aktif/Expired).
                        </p>
                    </div>
