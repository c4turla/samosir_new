...
const submit = () => {
    form.post('/landing-sites')
}
</script>

<template>
    <AppLayout>
        <Head title="Tambah Dermaga - SAMOSIR" />
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Tambah Dermaga</h1>
                <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
                    Isi formulir di bawah untuk menambahkan dermaga baru
                </p>
